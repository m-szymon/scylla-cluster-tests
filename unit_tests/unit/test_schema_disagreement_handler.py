...
S3_LINK = "https://test-bucket.s3.amazonaws.com/fake-upload.tar.gz"
# NOTE: the argus host is 'create_proxy_argus_s3_url' own output template, not a test input
PROXIED_S3_LINK = "https://argus.scylladb.com/api/v1/s3/test-bucket/fake-upload.tar.gz"
